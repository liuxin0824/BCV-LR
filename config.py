...
class Config:
    ...
    model: ModelConfig
    offline_pt: OfflineptConfig
    latent_policy_imitaiton: PolicyimitationConfig
    online_ft: OnlineftConfig
